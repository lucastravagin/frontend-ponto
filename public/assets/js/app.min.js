...
"use strict";app.controller("ColaboradorCtrl",["tabs","$http","consts","msgs","$ocLazyLoad","SweetAlert",function(e,t,c,a,o,l){var n=this,r=c.apiUrl+"/colaboradores";n.empresa=JSON.parse(localStorage.getItem(c.userKey));var s=c.apiUrl+"/colaborador-empresa/"+n.empresa._id;n.getColaboradores=function(){t.get(s).then(function(o){n.colaboradores=o.data,n.colaborador={},e.show(n,{tabList:!0,tabCreate:!0})}).catch(function(o){a.addError(o.data)})},n.createColaborador=function(){n.colaborador.empresa=n.empresa._id,t.post(r,n.colaborador).then(function(o){n.colaborador={},n.getColaboradores(),a.addSuccess("Colaborador cadastrado com sucesso")}).catch(function(o){a.addError(o.data.errors)})},n.updateColaborador=function(){var o=c.apiUrl+"/colaboradores/"+n.colaborador._id;t.put(o,n.colaborador).then(function(o){n.colaborador={},n.getColaborador(),e.show(n,{tabList:!0,tabCreate:!0}),a.addSuccess("Colaborador alterado com sucesso")}).catch(function(o){a.addError(o.data)})},n.deleteColaborador=function(r){l.swal({title:"Você Tem Certeza?",text:"Deseja Deletar Funcionário?",type:"warning",showCancelButton:!0,confirmButtonColor:"#DD6B55",confirmButtonText:"Sim, Deletar!",cancelButtonText:"Não, cancelar!",closeOnConfirm:!1,closeOnCancel:!1},function(o){if(o){var a=c.apiUrl+"/colaboradores/"+r._id;t.delete(a,n.colaborador).then(function(o){n.colaborador={},n.getColaboradores(),e.show(n,{tabList:!0,tabCreate:!0})}),l.swal("Deletado!","Seu Funcionário Foi Deletado.","success")}else l.swal("Cancelado",resp.data,"error")})},n.carregarDataNoSelect=function(){n.arrayMeses=["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"]},n.showTabUpdate=function(o){n.colaborador=o,e.show(n,{tabUpdate:!0})},n.showTabDelete=function(o){n.colaborador=o,e.show(n,{tabDelete:!0})},n.cancel=function(){e.show(n,{tabList:!0,tabCreate:!0})},n.getColaboradores()}]);
