...
"use strict";function _defineProperty(e,A,t){return A in e?Object.defineProperty(e,A,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[A]=t,e}app.controller("EmpresaCtrl",["tabs","$http","consts","msgs","$ocLazyLoad","SweetAlert",function(a,o,r,A,e,s){var n=this,t=r.apiUrl+"/empresas",i=JSON.parse(localStorage.getItem(r.userKey));n.getEmpresas=function(){o.get(t+"/"+i._id).then(function(e){n.empresas=e.data,n.empresa={},a.show(n,{tabList:!0,tabCreate:!0})}).catch(function(e){A.addError(e.data.errors)})},n.createEmpresa=function(){o.post(t,n.empresa).then(function(e){n.empresa={},n.getEmpresas(),A.addSuccess("Empresa Cadastrada com sucesso")}).catch(function(e){A.addError(e.data.errors)})},n.updateEmpresa=function(){var e=r.apiUrl+"/empresas/"+n.empresa._id;o.put(e,n.empresa).then(function(e){n.empresa={},n.getEmpresa(),a.show(n,{tabList:!0,tabCreate:!0}),A.addSuccess("Empresa alterada com sucesso")}).catch(function(e){A.addError(e.data)})},n.deleteEmpresa=function(t){s.swal({title:"Você Tem Certeza?",text:"Deseja Deletar Empresa?",type:"warning",showCancelButton:!0,confirmButtonColor:"#ff4b5b",confirmButtonText:"Sim, Deletar!",cancelButtonText:"Não, cancelar!",closeOnConfirm:!1,closeOnCancel:!0},function(e){if(e){var A=r.apiUrl+"/empresas/"+t._id;o.delete(A,n.empresa).then(function(e){n.empresa={},n.getEmpresas(),a.show(n,{tabList:!0,tabCreate:!0}),s.swal("Deletado!","Sua Empresa Foi Deletada.","success")})}else s.swal("Cancelled",resp.data,"error")})},n.showTabUpdate=function(e){n.empresa=e,a.show(n,{tabUpdate:!0})},n.showTabDelete=function(e){n.empresa=e,a.show(n,{tabDelete:!0})},n.cancel=function(){a.show(n,{tabList:!0,tabCreate:!0})},n.getEmpresas(),setTimeout(function(){var e;$("#datatable").DataTable(),$("#xp-default-datatable").DataTable({order:[[3,"desc"]]});var A=$("#datatable-buttons").DataTable((_defineProperty(e={lengthChange:!1,buttons:["copy","excel","pdf","print"]},"buttons",[{extend:"pdf",exportOptions:{columns:[0,1,2]},pageSize:"A4",text:"PDF",title:"Empresa Cadastrada no Oursys QrPonto",customize:function(e){e.content[1].margin=[50,0,50,0],e.content[1].table.widths=["35%","30%","35%"],e.content.splice(1,0,{margin:[0,0,0,12],alignment:"center",image:"data:image/png;base64,"})}},{extend:"excel",exportOptions:{columns:[0,1,2]}},{extend:"print",exportOptions:{columns:[0,1,2]},text:"Imprimir"},{extend:"copy",exportOptions:{columns:[0,1,2]},text:"Copiar"}]),_defineProperty(e,"oLanguage",{sProcessing:"Processando...",sLengthMenu:"Mostrar _MENU_ registros",sZeroRecords:"Não foram encontrados resultados",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando de 0 até 0 de 0 registros",sInfoFiltered:"",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primeiro",sPrevious:"Anterior",sNext:"Seguinte",sLast:"Último"}}),e));A.buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)")},500),setTimeout(function(){var e;$("#datatable").DataTable(),$("#xp-default-datatable").DataTable({order:[[3,"desc"]]});var A=$("#datatable-ponto").DataTable((_defineProperty(e={lengthChange:!1,buttons:["copy","excel","pdf","print"]},"buttons",[{extend:"pdf",exportOptions:{columns:[0,1,2]},pageSize:"A4",text:"PDF",title:"Empresa Cadastrada no Oursys QrPonto",customize:function(e){e.content[1].margin=[50,0,50,0],e.content[1].table.widths=["35%","30%","35%"],e.content.splice(1,0,{margin:[0,0,0,12],alignment:"center",image:"data:image/png;base64,"})}},{extend:"excel",exportOptions:{columns:[0,1,2]}},{extend:"print",exportOptions:{columns:[0,1,2]},text:"Imprimir"},{extend:"copy",exportOptions:{columns:[0,1,2]},text:"Copiar"}]),_defineProperty(e,"oLanguage",{sProcessing:"Processando...",sLengthMenu:"Mostrar _MENU_ registros",sZeroRecords:"Não foram encontrados resultados",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando de 0 até 0 de 0 registros",sInfoFiltered:"",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primeiro",sPrevious:"Anterior",sNext:"Seguinte",sLast:"Último"}}),e));A.buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)")},500)}]);
"use strict";function _defineProperty(e,A,o){return A in e?Object.defineProperty(e,A,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[A]=o,e}app.controller("RelatorioCtrl",["$http","consts","msgs",function(e,A,o){$(".xp-select2-single").select2();var t=this,a=A.apiUrl+"/colaboradores";t.empresa=JSON.parse(localStorage.getItem(A.userKey));var r=A.apiUrl+"/colaborador-empresa/"+t.empresa._id;t.colaboradores=[],t.getColaboradores=function(){e.get(r).then(function(e){t.colaboradores=e.data,t.colaborador={}}).catch(function(e){o.addError(e)})},t.getColaboradores(),t.localSearch=function(o,e){var t=[];return e.forEach(function(e){var A=e.nome+" "+e.pin+e.cpf;(0<=e.nome.toLowerCase().indexOf(o.toString().toLowerCase())||0<=e.pin.toLowerCase().indexOf(o.toString().toLowerCase())||0<=A.toLowerCase().indexOf(o.toString().toLowerCase()))&&t.push(e)}),t},t.getHorasTrabalhadas=function(A){console.log(A),e.get(a+"/"+A.originalObject._id+"/horas_trabalhadas").then(function(e){var o;t.horas_trabalhadas=e.data,o=A,setTimeout(function(){var e;$("#datatable").DataTable(),$("#xp-default-datatable").DataTable({order:[[3,"desc"]]});var A=$("#datatable-folha").DataTable((_defineProperty(e={lengthChange:!1,buttons:["copy","excel","pdf","print"]},"buttons",[{extend:"pdf",exportOptions:{columns:[0,1,2,3,4,5,6]},pageSize:"A4",text:"PDF",title:"Relatório de Ponto "+o.originalObject.nome,customize:function(e){e.content[1].margin=[25,0,25,0],e.content[1].table.widths=["25%","10%","10%","10%","10%","10%","25%"],e.content.splice(1,0,{margin:[0,0,0,12],alignment:"center",image:"data:image/png;base64,"})}},{extend:"excel",exportOptions:{columns:[0,1,2,3,4,5,6]}},{extend:"print",exportOptions:{columns:[0,1,2,3,4,5,6]},text:"Imprimir"},{extend:"copy",exportOptions:{columns:[0,1,2,3,4,5,6]},text:"Copiar"}]),_defineProperty(e,"oLanguage",{sProcessing:"Processando...",sLengthMenu:"Mostrar _MENU_ registros",sZeroRecords:"Não foram encontrados resultados",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando de 0 até 0 de 0 registros",sInfoFiltered:"",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primeiro",sPrevious:"Anterior",sNext:"Seguinte",sLast:"Último"}}),e));A.buttons().container().appendTo("#datatable-folha_wrapper .col-md-6:eq(0)")},300)}).catch(function(e){o.addError(e.data)})}}]);
