...
"use strict";app.controller("ColaboradorCtrl",["tabs","$http","consts","msgs","$ocLazyLoad","SweetAlert",function(r,t,e,a,o,c){var n=this,d=e.apiUrl+"/colaboradores";n.getColaboradores=function(){t.get(d).then(function(o){n.colaboradores=o.data,n.colaborador={},r.show(n,{tabList:!0,tabCreate:!0})}).catch(function(o){a.addError(o.data.errors)})},n.createColaborador=function(){t.post(d,n.colaborador).then(function(o){n.colaborador={},n.getColaboradores(),a.addSuccess("Colaborador cadastrado com sucesso")}).catch(function(o){a.addError(o.data.errors)})},n.updateColaborador=function(){var o=e.apiUrl+"/colaboradores/"+n.colaborador._id;t.put(o,n.colaborador).then(function(o){n.colaborador={},n.getColaborador(),r.show(n,{tabList:!0,tabCreate:!0}),a.addSuccess("Colaborador cadastrado com sucesso")}).catch(function(o){a.addError(o.data)})},n.deleteColaborador=function(){c.swal({title:"Você Tem Certeza?",text:"Deseja Deletar Funcionário?",type:"warning",showCancelButton:!0,confirmButtonColor:"#DD6B55",confirmButtonText:"Sim, Deletar!",cancelButtonText:"Não, cancelar!",closeOnConfirm:!1,closeOnCancel:!1},function(o){if(o){var a=e.apiUrl+"/colaboradores/"+n.colaborador._id;t.delete(a,n.colaborador).then(function(o){n.colaborador={},n.getColaboradores(),r.show(n,{tabList:!0,tabCreate:!0})}),c.swal("Deletado!","Seu Funcionário Foi Deletado.","success")}else c.swal("Cancelled",resp.data,"error")})},n.showTabUpdate=function(o){n.colaborador=o,r.show(n,{tabUpdate:!0})},n.showTabDelete=function(o){n.colaborador=o,r.show(n,{tabDelete:!0})},n.cancel=function(){r.show(n,{tabList:!0,tabCreate:!0})},n.getColaboradores()}]);
"use strict";app.constant("consts",{appName:"Qr Ponto",version:"1.0",owner:"Oursys",year:"2019",apiUrl:"http://localhost:4040/api",oapiUrl:"http://localhost:4040/oapi",buscaCNPJ:"https://www.receitaws.com.br/v1/cnpj",userKey:"qr_ponto_user"}).run(["$rootScope","consts",function(o,t){o.consts=t}]);
